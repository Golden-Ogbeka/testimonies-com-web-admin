...
export default [
  ...
  layout("layout/dashboard-layout/index.tsx", [
    ...
    route(`${RoutePaths.TESTIMONY_DETAILS}/:id`, "routes/testimonies/details.tsx"),
    ...
    route(RoutePaths.SUBSCRIPTION_CANCELLED, "routes/subscriptions/cancelled.tsx"),
    route(
    ...
    route(RoutePaths.COMMUNITY_GUIDELINES, "routes/content/community-guidelines.tsx"),
    ...
    route(`${RoutePaths.AUDIT_LOG_DETAILS}/:id`, "routes/audit-logs/details.tsx"),
