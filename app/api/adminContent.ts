...
export const AdminContentApi = {
  listFaq(params: ListFaqQuery) {
    return appAxios.get<ApiSuccessResponse<{ faqs: any }>>(
      "/admin/faq",
      { params },
    );
  },
  ...
  updatePrivacyPolicy(payload: Pick<SystemContentItem, "title" | "content" | "version">) {
  ...
  createTeamPermission(payload: Pick<TeamPermissionItem, "permission" | "description">) {
